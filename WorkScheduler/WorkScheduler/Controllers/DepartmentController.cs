...
namespace WorkScheduler.Controllers
{
    public class DepartmentController : Controller
    {
        ...
        public DepartmentController(EFCContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,ShortName")] DepartmentModel departmentModel)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,ShortName")] DepartmentModel departmentModel)
        {
